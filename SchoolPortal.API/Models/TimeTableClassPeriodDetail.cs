...
public partial class TimeTableClassPeriodDetail
{
    ...
    public virtual ICollection<TimeTableClassPeriodDetail> InversePeriod { get; set; } = new List<TimeTableClassPeriodDetail>();

    public virtual UserDetail? ModifiedByNavigation { get; set; }

    public virtual TimeTableClassPeriodDetail Period { get; set; } = null!;
