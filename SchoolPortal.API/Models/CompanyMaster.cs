...
public partial class CompanyMaster
{
    ...
    public virtual ICollection<SmstaskStatusMaster> SmstaskStatusMasters { get; set; } = new List<SmstaskStatusMaster>();

    public virtual ICollection<Smstask> Smstasks { get; set; } = new List<Smstask>();

    public virtual ICollection<SmtpDetail> SmtpDetails { get; set; } = new List<SmtpDetail>();
